...
df <- read.csv("../csv_validation_results/validation_mterics_SC_ID1_TS0.5_DS4_model15.csv")
filename<- "proportion_split-noshift_ID1_TS0.5_DS4_model15_R2.pdf"
...
df <- read.csv("../csv_validation_results/validation_mterics_SC_ID1_TS0.75_DS4_model15.csv")
filename<- "proportion_split-noshift_ID1_TS0.75_DS4_model15_R2.pdf"
