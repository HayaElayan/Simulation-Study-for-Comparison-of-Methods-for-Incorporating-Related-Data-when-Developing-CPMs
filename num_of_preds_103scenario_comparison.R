...
df <- read.csv("../csv_validation_results/validation_mterics_SC_ID103_TS0.25_DS4_model4.csv")
filename<- "numpredictors_ID103_TS0.25_DS4_model4_R2.pdf"
...
df <- read.csv("../csv_validation_results/validation_mterics_SC_ID103_TS0.25_DS4_model5.csv")
filename<- "numpredictors_ID103_TS0.25_DS4_model5_R2.pdf"
...
filename<- "numpredictors_ID103_TS0.25_DS4_model15_R2.pdf"
