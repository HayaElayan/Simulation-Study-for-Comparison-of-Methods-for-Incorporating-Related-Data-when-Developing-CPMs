...
boost_apparent<-read.csv("boot_apprent_ci.csv")

boost_apparent<- boost_apparent[boost_apparent$model_name != "Membership-based weighted model (weights limited to 1)" & boost_apparent$model_name != "Naive Logistic-developed on full data",]
boost_apparent
...
labels2 <- c('Apparent AUC', 'Apparent CITL', 'Apparent CSLOPE', 'Apparent BrierScore')
legends <- list()
figs <- list()
plots <- 0
...
filename<- "V2_bootstrap_apparent_ci.pdf"
